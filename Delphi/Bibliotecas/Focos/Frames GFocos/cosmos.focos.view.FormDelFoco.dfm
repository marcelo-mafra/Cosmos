object FrmDelFocus: TFrmDelFocus
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Desativa'#231#227'o de Foco'
  ClientHeight = 364
  ClientWidth = 508
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Label1: TLabel
      ...
      AutoSize = False
      Caption = 
        'Selecione o foco para o qual os alunos, pesquisadores, jovens e ' +
        'membros ser'#227'o transferidos antes da desativa'#231#227'o do foco.'
      WordWrap = True
    end
  ...
  object MSGroupHeader2: TMSGroupHeader
    ...
    object Label2: TLabel
      ...
      FocusControl = FmeSearchNewFocus.EdtSearch
    end
    object Label3: TLabel
      ...
      Width = 106
      Height = 13
      Caption = 'Foco a ser &desativado'
      FocusControl = FmeSearchFocoDesativado.EdtSearch
    end
    inline FmeSearchNewFocus: TFmeSearchData
      Left = 0
      Top = 80
      Width = 413
      Height = 25
    ...
    inline FmeSearchFocoDesativado: TFmeSearchData
      Left = 1
      Top = 36
      Width = 412
      Height = 25
