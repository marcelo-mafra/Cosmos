...
begin
 case CampoTrabalho of
   ctLectorium: sFilter := sFilter.Format(TFilterData.CAMDIS_INDESCINT_INDATI, [QuotedStr('LEC'), QuotedStr('N'), QuotedStr('S')]);
   ctTM: sFilter := sFilter.Format(TFilterData.CAMDIS_INDESCINT_INDATI, [QuotedStr('TMO'), QuotedStr('N'), QuotedStr('S')]);
   ctTP: sFilter := sFilter.Format(TFilterData.CAMDIS_INDESCINT_INDATI, [QuotedStr('TPU'), QuotedStr('N'), QuotedStr('S')]);
   ctEI: sFilter := sFilter.Format(TFilterData.CAMDIS_INDESCINT_INDATI, [QuotedStr('LEC'), QuotedStr('S'), QuotedStr('S')]);
   ctSimpatizantes: sFilter := sFilter.Format(TFilterData.CAMDIS_INDESCINT_INDATI, [QuotedStr('SIM'), QuotedStr('N'), QuotedStr('S')]);
 end;
