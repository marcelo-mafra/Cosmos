...
type
 ...
 //Representa como se dará o acesso a um foco: modo de escrita ou somente leitura.
  ...
  //Representa um usuário de uma dos aplicativos Cosmos.
  TCosmosUser = class
   private
    FLogin: string;
    FFoco: string;
  ...
  //Representa uma seção aberta de usuário em um dos aplicativos Cosmos.
  ...
  //Encapsula os objetos relacionados à segurança, tais como usuário, seção etc.
