...
uses
  Vcl.DBCtrls {TDataLink}, Windows {HPalette}, Data.Db {TField}, Vcl.Graphics, System.Classes {TStream},
  Vcl.Controls {TCustomControl}, Vcl.Forms {TBorderStyle}, uEDBR {Main Routines},
  Messages {TMessage};
...
implementation
uses Vcl.Clipbrd, Vcl.Imaging.jpeg;
