unit cosmos.server.conferencias.mainform;
...
uses
  ...
  //IdHTTPWebBrokerBridge, IdSSLOpenSSL, Web.HTTPApp, IdSchedulerOfThreadPool;
...
{Executa o servidor standalone https, iniciando por obter as configurações
 ...
 try
  ...
  APort := aStarterFile.ReadInteger('GCON', 'DSHTTPService.HttpsPort', 443);
  //Número máximo de conexões concorrentes que serão aceitas pelo servidor.
  MaxConnections := aStarterFile.ReadInteger('GCON', 'DSHTTPService.MaxConnections', 100);
