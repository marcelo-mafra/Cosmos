unit cosmos.server.users.mainform;
...
//  IdSSLOpenSSL, IdHTTPWebBrokerBridge, IdSchedulerOfThreadPool;
...
{Executa o servidor standalone https, iniciando por obter as configurações
 ...
 try
  ...
  APort := aStarterFile.ReadInteger('GUSU', 'DSHTTPService.HttpsPort', 443);
  //Número máximo de conexões concorrentes que serão aceitas pelo servidor.
  MaxConnections := aStarterFile.ReadInteger('GUSU', 'DSHTTPService.MaxConnections', 100);
