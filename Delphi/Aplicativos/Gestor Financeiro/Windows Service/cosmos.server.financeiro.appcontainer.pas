...
type
  ...
  TDMFinanceiroAppContainer = class(TService)
...
begin
  DMFinanceiroAppContainer.Controller(CtrlCode);
end;
...
function TDMFinanceiroAppContainer.GetServiceController: TServiceController;
begin
...
procedure TDMFinanceiroAppContainer.ServiceStart(Sender: TService;
  var Started: Boolean);
begin
...
function TDMFinanceiroAppContainer.DoContinue: Boolean;
begin
  Result := inherited;
  DSServerFinanceiro.Start;
end;

procedure TDMFinanceiroAppContainer.DoInterrogate;
begin
  inherited;
end;

function TDMFinanceiroAppContainer.DoPause: Boolean;
begin
  DSServerFinanceiro.Stop;
  Result := inherited;  DSServerFinanceiro.Stop;
end;

function TDMFinanceiroAppContainer.DoStop: Boolean;
begin
  DSServerFinanceiro.Stop;
  Result := inherited;
end;
