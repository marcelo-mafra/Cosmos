object DMCosmosConferenciasMethods: TDMCosmosConferenciasMethods
  OldCreateOrder = False
  Height = 835
  Width = 777
  object SQLConferencia: TSQLDataSet
    BeforeOpen = SQLConferenciaBeforeOpen
    CommandText = 
  ...
  object DspConferencia: TDataSetProvider
    ...
    OnUpdateError = DspConferenciaUpdateError
    Left = 48
    Top = 127
  end
  ...
  object SQLInscrto: TSQLDataSet
    ...
    CommandText = 
      ...
      'ATINS, DATSAI, HORCHE, HORSAI, INDMON, INDSUB, '#13#10'MATCAD, MODTRA,' +
      ' NOMALO, NOMCAD, NUMINS, NUMLEI, NUMQUA, SEXCAD, SIGDIS, SIGFOC,' +
      ' INDPRE, FORINS, USURES '#13#10'from VIW_INSCRICOES where codins = :co' +
      'dins'
    MaxBlobSize = 1
    Params = <
      item
  ...
  object DspRecadosResumido: TDataSetProvider
    DataSet = SQLRecadosResumido
    Options = [poIncFieldProps, poReadOnly, poUseQuoteChar]
    UpdateMode = upWhereKeyOnly
    Left = 592
    Top = 448
  end
  object SQLRecadosResumido: TSQLDataSet
    SchemaName = 'sysdba'
    BeforeOpen = SQLConferenciaBeforeOpen
    CommandText = 
    ...
    Left = 552
    Top = 448
    object SQLRecadosResumidoCODNOT: TIntegerField
      FieldName = 'CODNOT'
      ProviderFlags = [pfInUpdate, pfInKey]
      Required = True
      Visible = False
    end
    object SQLRecadosResumidoCODINS: TIntegerField
      FieldName = 'CODINS'
      ProviderFlags = []
      Required = True
      Visible = False
    end
    object SQLRecadosResumidoASSNOT: TStringField
      FieldName = 'ASSNOT'
      ProviderFlags = []
      Required = True
      Size = 35
    end
    object SQLRecadosResumidoNOTINS: TStringField
      FieldName = 'NOTINS'
      ProviderFlags = []
      Required = True
      Size = 60
    end
    object SQLRecadosResumidoINDCRA: TStringField
      FieldName = 'INDCRA'
      ProviderFlags = [pfInUpdate]
      FixedChar = True
      Size = 3
  ...
  object DspRecados: TDataSetProvider
    ...
    UpdateMode = upWhereKeyOnly
    OnUpdateError = DspProgramacaoUpdateError
    OnGetDataSetProperties = DspRecadosGetDataSetProperties
    Left = 592
    Top = 512
  end
  object SQLRecados: TSQLDataSet
    BeforeOpen = SQLConferenciaBeforeOpen
    CommandText = 
      'select * from NOTAS_INSCRITO where codins = :codins order by dat' +
      'cad'
    MaxBlobSize = 1
    Params = <
      item
    ...
    object SQLRecadosNOTINS: TMemoField
      FieldName = 'NOTINS'
      ProviderFlags = [pfInUpdate]
      Required = True
      Visible = False
    ...
    object SQLRecadosRESNOT: TStringField
      FieldName = 'RESNOT'
      ProviderFlags = [pfInUpdate]
      Required = True
      Visible = False
    ...
    object SQLRecadosDATCAD: TSQLTimeStampField
      DisplayLabel = 'Data'
      FieldName = 'DATCAD'
      ProviderFlags = [pfInUpdate]
      Required = True
