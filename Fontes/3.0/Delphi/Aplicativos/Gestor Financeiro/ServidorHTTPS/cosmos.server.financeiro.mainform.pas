unit cosmos.server.financeiro.mainform;
...
{Executa o servidor standalone https, iniciando por obter as configurações
 ...
 try
  ...
  APort := aStarterFile.ReadInteger('GFIN', 'DSHTTPService.HttpsPort', 443);
  //Número máximo de conexões concorrentes que serão aceitas pelo servidor.
  MaxConnections := aStarterFile.ReadInteger('GFIN', 'DSHTTPService.MaxConnections', 100);
