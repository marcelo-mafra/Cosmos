...
type
  ...
  TDMUsuariosAppContainer = class(TService)
...
begin
  DMUsuariosAppContainer.Controller(CtrlCode);
end;
...
function TDMUsuariosAppContainer.GetServiceController: TServiceController;
begin
...
procedure TDMUsuariosAppContainer.ServiceStart(Sender: TService;
  var Started: Boolean);
begin
...
function TDMUsuariosAppContainer.DoContinue: Boolean;
begin
  Result := inherited;
  DSServerUsuarios.Start;
end;

procedure TDMUsuariosAppContainer.DoInterrogate;
begin
  inherited;
end;

function TDMUsuariosAppContainer.DoPause: Boolean;
begin
  DSServerUsuarios.Stop;
  Result := inherited;
end;

function TDMUsuariosAppContainer.DoStop: Boolean;
begin
  DSServerUsuarios.Stop;
  Result := inherited;
end;
