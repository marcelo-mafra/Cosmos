object DMFocosAppContainer: TDMFocosAppContainer
  OldCreateOrder = False
  OnCreate = DataModuleCreate
  Height = 453
  Width = 489
  object DSServerFocos: TDSServer
    OnPrepare = DSServerFocosPrepare
    OnConnect = DSServerFocosConnect
    OnDisconnect = DSServerFocosDisconnect
    OnError = DSServerFocosError
    OnTrace = DSServerFocosTrace
    Left = 96
    Top = 11
  end
  ...
  object DSServerApplicationClass: TDSServerClass
    ...
    Server = DSServerFocos
    Left = 280
    Top = 11
  end
  object DSServerFocosClass: TDSServerClass
    OnGetClass = DSServerFocosClassGetClass
    Server = DSServerFocos
    Left = 280
    Top = 67
  end
