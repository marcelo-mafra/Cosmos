object FrmExportarCadastrados: TFrmExportarCadastrados
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Exportar Cadastrados'
  ClientHeight = 565
  ClientWidth = 553
  Color = clBtnFace
  ...
  object MSGroupHeader1: TMSGroupHeader
    ...
    Font.Style = []
    ParentFont = False
    object ChkDadosPessoais: TCheckBox
      Left = 4
      Top = 22
      Width = 97
      Height = 17
  ...
  object MSGroupHeader2: TMSGroupHeader
    ...
    DesignSize = (
      539
      241)
    object LsvDiscipulados: TListView
      Left = 4
      Top = 24
      Width = 525
      Height = 210
