...
uses
  ...
  cosmos.framework.interfaces.DataAcess, cosmos.system.winshell,
  cosmos.system.types, Data.DB;
...
begin
 ...
 try
  ...
  case Campo of
   ctLectorium: ADataset.Filter := Format('CAMDIS = %s and INDATI = %s', [QuotedStr('LEC'), QuotedStr('S')]);
   ctTM: ADataset.Filter := Format('CAMDIS = %s and INDATI = %s', [QuotedStr('TMO'), QuotedStr('S')]);
   ctTMB: ADataset.Filter := Format('CAMDIS = %s and INDATI = %s', [QuotedStr('TMB'), QuotedStr('S')]);
   ctTP: ADataset.Filter := Format('CAMDIS = %s and INDATI = %s', [QuotedStr('TPU'), QuotedStr('S')]);
   ctEI: ADataset.Filter := Format('CAMDIS = %s and INDESCINT = %s and INDATI = %s', [QuotedStr('LEC'), QuotedStr('S'), QuotedStr('S')]);
  end;

  if ADataset <> nil then
   begin
    ADataset.Filtered := True;
    ADataset.IndexFieldNames := 'CAMDIS;SEQDIS';
