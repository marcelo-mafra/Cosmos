...
uses
  ...
  cosmos.frames.gridsearch, DB, Datasnap.DSConnect,
  ...
  ActnPopup, cosmos.system.messages, XPStyleActnCtrls, DockTabSet,
  ...
  System.Actions, Cosmos.Framework.Interfaces.DataAcess;
...
begin
 ...
 try
  ...
  ADataset.Filter := Format('CAMDIS = %s and INDATI = %s', [QuotedStr('TPU'), QuotedStr('S')]);
