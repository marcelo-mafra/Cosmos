...
uses
  ...
  Vcl.ActnList, ImgList, Data.DB, Datasnap.DBClient, ExtCtrls,
  ...
  Menus, ActnPopup, cosmos.system.messages, StdCtrls, XPStyleActnCtrls,
...
begin
 ...
 try
  ...
  ADataset.Filter := Format('CAMDIS = %s and INDATI = %s', [QuotedStr('LEC'), QuotedStr('S')]);
